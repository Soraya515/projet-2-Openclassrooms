	...
	<div id="footer-cols-inner">
		...
		<div class="col2a">
			...
			<?php if ( !dynamic_sidebar( 'footer-column-1-widget-area' ) ) : ?>
						...
						<h2 class="sidebar-title">
							<?php esc_html_e('Footer Col Widget 1', 'ftourism'); ?>
						</h2><!-- .sidebar-title -->
						...
						<div class="textwidget">
							<?php esc_html_e('This is first footer widget area. To customize it, please navigate to Admin Panel -> Appearance -> Widgets and add widgets to Footer Column #1.', 'ftourism'); ?>
						</div><!-- .textwidget -->
		...
		<div class="col2b">
			<?php if ( !dynamic_sidebar( 'footer-column-2-widget-area' ) ) : ?>
					...
					<h2 class="sidebar-title">
						<?php esc_html_e('Footer Col Widget 2', 'ftourism'); ?>
					</h2><!-- .sidebar-title -->
					...
					<div class="textwidget">
						<?php esc_html_e('This is second footer widget area. To customize it, please navigate to Admin Panel -> Appearance -> Widgets and add widgets to Footer Column #2.', 'ftourism'); ?>
					</div><!-- .textwidget -->
